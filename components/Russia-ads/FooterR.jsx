...
export default function FooterR() {
  ...
  const primaryPhone = "+7-9859834837";

  const primaryPhoneHref = "tel:+79859834837";
    ...
    <footer className="relative overflow-hidden pt-10 pb-5 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-5">
          ...
          {/* CONTACT */}
          <div id="contact-us">
            <h3 className="mb-4 font-serif text-xl font-semibold">Контакты</h3>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="whitespace-pre-line leading-relaxed">
                  ул. 26 Бакинских Комиссаров, дом 9, кв. 9, Москва 119571,
                  Россия
                </p>
              </div>
