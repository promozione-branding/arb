...
const industries = [
  {
    ...
    applications: [
      ...
      { name: "Ротоваторы", icon: Settings2 },
      { name: "Плуги и дисковые бороны", icon: Shovel },
      { name: "Ирригационное оборудование", icon: Droplets },
      { name: "Сельскохозяйственные прицепы и оборудование", icon: Truck },
      { name: "Сельскохозяйственные редукторы и системы ВОМ", icon: Settings2 },
...

  {
    ...
    applications: [
      ...
      { name: "Колёсные погрузчики", icon: Truck },
      { name: "Экскаваторы-погрузчики", icon: Construction },
      { name: "Бульдозеры", icon: Construction },
      { name: "Автогрейдеры", icon: Construction },
      { name: "Самосвалы и карьерные грузовики", icon: Truck },
      { name: "Краны", icon: Construction },
      { name: "Вилочные погрузчики", icon: Forklift },
      { name: "Бетоносмесители", icon: Construction },
      { name: "Бетононасосы", icon: Construction },
      { name: "Дорожные катки и виброкатки", icon: Construction },
      { name: "Дробильное оборудование", icon: Settings2 },
      { name: "Горнодобывающее и карьерное оборудование", icon: Pickaxe },
    ],
  },

  {
    ...
    applications: [
      ...
      { name: "Высокооборотные двигатели", icon: Gauge },
      { name: "Мотор-редукторы", icon: Settings2 },
      { name: "Сервоприводы и сервомоторы", icon: Settings2 },
      { name: "Тяговые электродвигатели", icon: Zap },
      { name: "Двигатели насосов", icon: Fuel },
      { name: "Двигатели вентиляторов и воздуходувок", icon: Wind },
      { name: "Двигатели компрессоров", icon: Settings2 },
      { name: "Генераторы и генераторные системы", icon: Zap },
    ],
  },

  {
    title: "Конвейеры и транспортировка материалов",
    ...
    applications: [
      ...
      { name: "Оборудование для транспортировки материалов", icon: PackageCheck },
      { name: "Краны и подъёмники", icon: Construction },
      { name: "Складские и логистические системы", icon: Warehouse },
    ],
  },

  {
    ...
    applications: [
      ...
      { name: "Целлюлозно-бумажная промышленность", icon: Factory },
      { name: "Сахарные заводы", icon: Factory },
      { name: "Ветроэнергетика", icon: Wind },
      { name: "Промышленные редукторы", icon: Settings2 },
      { name: "Тяжёлое машиностроение и металлоконструкции", icon: Factory },
    ],
  },

  {
    ...
    icon: Train,
    applications: [
      { name: "Локомотивы", icon: Train },
      { name: "Железнодорожные вагоны", icon: Train },
      // { name: "Мопеды", icon: Bike },
    ],
  },

  {
    title: "Двух- и трёхколёсная техника",
    image: "/industry/2 and 3 Wheeler.webp",
    icon: Bike,
    applications: [
      { name: "Мотоциклы", icon: Bike },
      { name: "Скутеры", icon: Bike },
      { name: "Электрические двухколёсные транспортные средства", icon: Bike },
      { name: "Трёхколёсные транспортные средства", icon: Truck },
      { name: "Электрические трёхколёсные транспортные средства", icon: Truck },
      { name: "Колёсные и ступичные узлы", icon: CircleDot },
      { name: "Мопеды", icon: Bike },
      { name: "Грузовые трициклы", icon: Truck },
    ],
  },

  {
    ...
    applications: [
      ...
      { name: "Редукторы строительной техники", icon: Construction },
      { name: "Горнодобывающие редукторы", icon: Pickaxe },
      { name: "Приводные системы конвейеров", icon: Settings2 },
      { name: "Планетарные редукторы", icon: Settings2 },
      { name: "Электромотор-редукторы", icon: Zap },
      { name: "Системы передачи мощности", icon: Settings2 },
      { name: "Редукторы прокатных станов", icon: Settings2 },
    ],
  },
                ...
                <SwiperSlide key={index}>
                  ...
                  >
                    ...
                    <button
                      ...
                      aria-label={`Просмотреть области применения: ${item.title}`}
                      className="
                        absolute
                        right-1
                        top-1
                    ...
                    {/* Content */}
                    <div className="absolute bottom-2 left-2 z-10 md:bottom-6 md:left-6 md:right-6">
                      <div className="flex items-center gap-1 md:gap-3">
                        ...
                        <h3 className="line-clamp-1 text-[10px] font-semibold text-white md:text-xl">
                          {item.title}
                        </h3>
                      </div>
                    </div>
                ...
                <div className="relative flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="mt-1 text-2xl font-bold text-white md:text-3xl">
                      Применение: {selectedIndustry.title}
                    </h2>
                  </div>
                </div>
              </div>
