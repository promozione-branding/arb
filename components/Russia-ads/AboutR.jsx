...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="relative overflow-hidden bg-white py-14 sm:py-16">
      {/* Background Blur */}
      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-14 px-4 md:gap-16 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="relative overflow-visible">
                ...
                {gallery.map((image, index) => (
                  <SwiperSlide key={index}>
                    ...
                    >
                      <Image
                        src={image}
                        alt={`ARB Bearings — слайд ${index + 1}`}
                        width={100}
                        height={100}
                        priority={index === 0}
                        sizes="
            ...
            >
              ...
              <p className="mt-2 text-xs leading-5 text-gray-300 sm:text-sm">
                лет инженерного опыта и производственного мастерства
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <p
            ...
            "
          >
            Обладая более чем 60-летним опытом в индустрии подшипников и
            производственными мощностями, работающими с 1990 года, ARB Bearings
            зарекомендовала себя как надёжный производитель высококачественных
            подшипников для клиентов по всему миру. Наши прецизионные подшипники
            разработаны для обеспечения долговечности, надёжности и стабильной
            работы в тяжёлых условиях эксплуатации и различных отраслях
            промышленности.
          </p>
