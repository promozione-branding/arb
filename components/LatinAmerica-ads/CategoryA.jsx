...
const products = [
  {
    title: "Rodamientos de bolas de contacto angular",
    image: "/arb-images/DOUBLE POINT ANGULAR1.webp",
    desc: "Diseñados para soportar simultáneamente cargas radiales y axiales, ofreciendo alta rigidez y un rendimiento estable en sistemas industriales.",
    link: "/products/ball-bearing/double-row-angular-contact-bearings",
  },
  {
    title: "Rodamientos de bolas de cuatro puntos de contacto",
    image: "/arb-images/FOUR POINT ANGULAR CONTACT1.webp",
    desc: "Diseñados para soportar cargas axiales en ambas direcciones con un diseño compacto. Ideales para cajas de engranajes, bombas y equipos industriales.",
    link: "/products/ball-bearing/four-point-contact-ball-bearings",
  },
  {
    title: "Rodamientos rígidos de bolas",
    image: "/arb-images/BALL BEARING 62208 2RS1.webp",
    desc: "Rodamientos de alta precisión que proporcionan una rotación suave, baja fricción, altas velocidades de funcionamiento y una larga vida útil.",
    link: "/products/ball-bearing/deep-groove-ball-bearing",
  },
  {
    title: "Rodamientos de buje de rueda",
    image: "/arb-images/Wheel Bearing1.webp",
    desc: "Rodamientos de alto rendimiento diseñados para una rotación suave de las ruedas, menor fricción y un funcionamiento fiable en sistemas automotrices.",
    link: "/products/wheel-bearing/wheel-bearings",
  },
  {
    title: "Rodamientos de rodillos cilíndricos",
    image: "/arb-images/CYLINDRICAL1.webp",
    desc: "Diseñados para soportar altas cargas radiales, proporcionando rigidez y eficiencia en motores eléctricos, cajas de engranajes y equipos pesados.",
    link: "/products/roller-bearings/cylindrical-roller-bearings",
  },
  {
    title: "Rodamientos de rodillos cónicos",
    image: "/arb-images/TAPER ROLLER.webp",
    desc: "Rodamientos fiables para cargas radiales y axiales combinadas, con alta resistencia, precisión y una larga vida útil.",
      ...
      <div className="relative mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="mb-7 flex flex-col justify-between gap-5 md:mb-10 md:flex-row md:items-end">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
              Rodamientos de alta precisión para equipos industriales y automotrices.
            </p>
        ...
        <div className="mt-6 flex flex-col gap-4 border-t border-slate-200 pt-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="text-xs text-slate-500 sm:text-sm">
            Rodamientos de alta precisión para aplicaciones industriales exigentes.
          </p>
