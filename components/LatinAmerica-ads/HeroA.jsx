...
const features = [
  {
    icon: Award,
    title: "Fabricado en India",
    number: "01",
  },
  {
    icon: BadgeCheck,
    title: "Certificación IATF",
    number: "02",
  },
  {
    icon: Globe2,
            ...
            <div className="hero-content order-2 w-full text-center lg:order-1 lg:text-left">
              ...
              >
                ...
                <p
                  ...
                  "
                >
                  ALTA PRECISIÓN. CONFIANZA EN TODO EL MUNDO.
                </p>
              </div>
              ...
              <p
                ...
                "
              >
                Rodamientos de bolas y rodillos de alta calidad,
                diseñados para aplicaciones industriales y automotrices
                exigentes, suministrados desde India a clientes de todo el mundo.
              </p>
              ...
              >
                {bearingImages.map((_, index) => (
                  <button
                    key={index}
                    type="button"
                    aria-label={`Ir al rodamiento ${index + 1}`}
