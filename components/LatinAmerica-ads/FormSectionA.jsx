...
const bearingTypes = [
  ...
  "Rodamientos de buje de rueda",
  "Rodamientos axiales de bolas",
  "Rodamientos de bolas autoalineables",
];

export default function FormSectionA() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.phone.trim()) {
      toast.error("Por favor, introduzca su número de teléfono.");
    ...
    if (!formData.message.trim()) {
      toast.error("Por favor, introduzca su mensaje.");
    ...
    if (!phoneRegex.test(formData.phone.trim())) {
      toast.error("Por favor, introduzca un número de teléfono válido.");
...
${formData.message}
      ...
      if (data?.success) {
        const successMessage =
          "¡Solicitud enviada correctamente! Nuestro equipo se pondrá en contacto con usted lo antes posible.";
      ...
      const errorMessage =
        "Se produjo un error en el servidor. Por favor, inténtelo de nuevo.";
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="relative">
            ...
            <p
              ...
              "
            >
              ¿Busca la solución adecuada para su aplicación? Cuéntenos sus
              requisitos y nuestro equipo técnico le ayudará a seleccionar el
              rodamiento y las especificaciones adecuadas.
            </p>

            {/* Bearing Types */}
            <div className="mt-7">
              <h3 className="mb-4 text-sm font-bold uppercase tracking-[2px] text-slate-900">
                Nuestros rodamientos de bolas
              </h3>
            ...
            >
              ...
              <div className="relative flex min-h-[300px] items-center justify-center px-8 py-8 sm:min-h-[360px]">
                <Image
                  ...
                  alt="Rodamiento de bolas ARB Bearings"
                  width={650}
                  height={650}
                  className="
                    relative
            ...
            >
              ...
              <div className="mb-7">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Déjenos sus requisitos y nuestro equipo se pondrá en contacto
                  con usted.
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={5}
                      placeholder="Cuéntenos sus requisitos..."
                      className="
                        w-full
                        resize-none
                        rounded-xl
