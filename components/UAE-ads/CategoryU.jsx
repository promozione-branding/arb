...
const products = [
  {
    title: "محامل كروية ذات تلامس زاوي",
    image: "/arb-images/DOUBLE POINT ANGULAR1.webp",
    desc: "مصممة لتحمل الأحمال الشعاعية والمحورية في الوقت نفسه، مع توفير صلابة عالية وأداء مستقر في الأنظمة الصناعية.",
    link: "/products/ball-bearing/double-row-angular-contact-bearings",
  },
  {
    title: "محامل كروية ذات أربع نقاط تلامس",
    image: "/arb-images/FOUR POINT ANGULAR CONTACT1.webp",
    desc: "مصممة لتحمل الأحمال المحورية في كلا الاتجاهين مع تصميم مدمج. مثالية لعلب التروس والمضخات والمعدات الصناعية.",
    link: "/products/ball-bearing/four-point-contact-ball-bearings",
  },
  {
    title: "محامل كروية ذات أخدود عميق",
    image: "/arb-images/BALL BEARING 62208 2RS1.webp",
    desc: "محامل عالية الدقة توفر دورانًا سلسًا واحتكاكًا منخفضًا وسرعات تشغيل عالية وعمر خدمة طويل.",
    link: "/products/ball-bearing/deep-groove-ball-bearing",
  },
  {
    title: "محامل محور العجلة",
    image: "/arb-images/Wheel Bearing1.webp",
    desc: "محامل عالية الأداء مصممة لدوران العجلات بسلاسة، وتقليل الاحتكاك، وتشغيل موثوق في أنظمة السيارات.",
    link: "/products/wheel-bearing/wheel-bearings",
  },
  {
    title: "محامل أسطوانية",
    image: "/arb-images/CYLINDRICAL1.webp",
    desc: "مصممة لتحمل الأحمال الشعاعية العالية، وتوفر الصلابة والكفاءة في المحركات الكهربائية وعلب التروس والمعدات الثقيلة.",
    link: "/products/roller-bearings/cylindrical-roller-bearings",
  },
  {
    title: "محامل أسطوانية مخروطية",
    image: "/arb-images/TAPER ROLLER.webp",
    desc: "محامل موثوقة للأحمال الشعاعية والمحورية المركبة، مع قوة ودقة وعمر خدمة طويل.",
    link: "/products/roller-bearings/tapered-roller-bearings",
  },
];

export default function CategoryU() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#f7f9fc] py-10 md:py-16">
      ...
      <div className="relative mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="mb-7 flex flex-col justify-between gap-5 md:mb-10 md:flex-row md:items-end">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
              محامل عالية الدقة للمعدات الصناعية والسيارات.
            </p>
          </div>
        ...
        <div className="mt-6 flex flex-col gap-4 border-t border-slate-200 pt-5 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-slate-500 sm:text-sm">
            محامل عالية الدقة للتطبيقات الصناعية الصعبة.
          </p>
      ...
      {isFormOpen && (
        <EnquiryU IATFpen={isFormOpen} onClose={() => setIsFormOpen(false)} />
      )}
    </section>
  );
}
