...
export default function ProductsU() {
  const [isFormOpen, setIsFormOpen] = useState(false);
      ...
      <div className="relative mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="mx-auto mb-6 max-w-3xl text-center sm:mb-10">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
            استكشف مجموعتنا الكاملة من المحامل عالية الدقة، المصممة لتطبيقات
            السيارات والصناعات والمعدات الزراعية والسكك الحديدية والبناء
            والآلات الثقيلة.
          </p>
        </div>
        ...
        {/* 01. Ball Bearings */}
        <ProductSlider
          title="المحامل الكروية"
          subtitle="محامل كروية عالية الأداء، مصممة للتشغيل السلس والاحتكاك المنخفض والسرعات العالية وعمر الخدمة الطويل."
        ...
        <div className="mt-5 border-t border-slate-200 pt-4 sm:mt-7 sm:pt-7">
          <ProductSlider
            title="المحامل الأسطوانية"
            subtitle="محامل أسطوانية موثوقة، مصممة لتحمل الأحمال العالية والظروف الصعبة والتشغيل الصناعي المستمر."
        ...
        <div className="mt-5 border-t border-slate-200 pt-4 sm:mt-7 sm:pt-7">
          <ProductSlider
            title="محامل أخرى"
            subtitle="مجموعة واسعة من المحامل للآلات المستخدمة في قطاعات السيارات والتعدين والزراعة والسكك الحديدية والبناء والصناعة."
        ...
        <div className="mt-14 rounded-3xl bg-[#081829] px-6 py-8 text-center shadow-2xl sm:px-10 sm:py-10 lg:mt-20">
          ...
          <h3 className="mt-3 text-2xl font-bold text-white sm:text-3xl">
            الدقة. الأداء. الموثوقية.
          </h3>

          <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-gray-400">
            اعثر على الحل المناسب لتطبيقك. سيساعدك خبراؤنا في اختيار المحمل
            المناسب وإعداد عرض السعر.
          </p>
