      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-14 px-4 md:gap-16 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="relative overflow-visible">
            ...
            >
              ...
              <p className="mt-2 text-xs leading-5 text-gray-300 sm:text-sm">
                أكثر من 60 عامًا من الخبرة في الهندسة والتميز في التصنيع
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <p
            ...
            "
          >
            مع أكثر من 60 عامًا من الخبرة في صناعة المحامل ومنشآت تصنيع
            تعمل منذ عام 1990، رسخت ARB Bearings مكانتها كشركة مصنعة موثوقة
            للمحامل عالية الجودة للعملاء في جميع أنحاء العالم. تم تصميم
            محاملنا الدقيقة لتوفير المتانة والموثوقية والأداء المستقر في
            الظروف الصعبة ومختلف الصناعات.
          </p>
