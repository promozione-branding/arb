export default {
  ...
  subCategory: {
    name: "Double Row Angular Contact Ball Bearings",
    slug: "double-row-angular-contact-ball-bearings",
    image: "/arb-images/DOUBLE POINT ANGULAR.png",
    heroTitle: "Double Row Angular Contact Ball Bearings",


    description:
      "High-performance double row angular contact ball bearings designed for superior radial and axial load capacity, smooth operation, and long-lasting reliability in demanding industrial applications.",
