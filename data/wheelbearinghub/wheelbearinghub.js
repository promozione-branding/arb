export default {
  category: {
    ...
    pageContent: {
      ...
      section1: {
        badge: "Premium Wheel Hub Bearings",
        title: "Engineered for Smooth Performance & Long Service Life",
        description:
        ...
        features: [
          ...
          "Corrosion Resistant — Enhanced protection against corrosion and wear.",
          "Reliable Performance — Smooth and consistent operation.",

        ],
      },

      section2: {
        badge: "Engineered for Superior Performance",
  ...
  products: [
...

    {
      ...
      "dimensions": {
        ...
        "Overall Width (mm)": 43.6,
        "Inner Ring Width (mm)": 60,
    ...
    },
    {
      ...
      "dimensions": {
        ...
        "Overall Width (mm)": 43.3,
        "Inner Ring Width (mm)": 67.5,
    ...
    },
    {
      ...
      "dimensions": {
        ...
        "Overall Width (mm)": null,
        "Inner Ring Width (mm)": 38,
        "Outer Ring Width (mm)": null,
        "Mass (Kg)": 0.67
      },
      "image": "/arb-images/Wheel-Bearing.png",
