...
const Location = () => {
  ...
  const faqs = [
    ...
    {
      question: "How can I request a bearing quotation from ARB Bearings?",
      answer:
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-3 text-lg  text-slate-900">
                ARB Bearings is a globally recognized Bearing Manufacturer
                delivering high-performance bearing solutions to customers
                across {city} and international markets. With decades of
                engineering excellence, advanced manufacturing capabilities, and
                an unwavering commitment to quality, we manufacture
                precision-engineered bearings that meet the demanding
                requirements of modern industries. As an experienced Bearing
                Manufacturer, we serve industries including automotive, mining,
                construction, agriculture, power generation, steel, and heavy
                engineering. Our bearings are trusted for their exceptional
                durability, precision, high load-carrying capacity, and long
                service life. Every product is manufactured using premium-grade
              ...
              <div className="mt-7 grid gap-5 sm:grid-cols-2">
                {["Extensive Product Range", "In-House Manufacturing"].map(
                  (item) => (
                    <div
                      key={item}
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[30px] border border-slate-200 bg-white p-8 shadow-2xl">
                ...
                <h2 className="text-3xl font-bold leading-tight text-[#1B2A41]">
                  Powering Performance with the Right Bearing
                </h2>

                <p className="mt-6 text-lg leading-8 text-slate-600">
                  From standard applications to demanding industrial
                  requirements, ARB Bearings delivers precision-engineered
                  bearing solutions built for performance, durability, and
                  reliability.
                </p>
        ...
        <div className="relative mx-auto w-full px-6 lg:px-18">
          ...
          <div className="mx-auto max-w-5xl text-center">
            ...
            <h2 className="mt-6 text-5xl font-bold leading-tight text-[#1B2A41] ">
              Why ARB Bearings Is the Right Choice for Your Bearing Needs
            </h2>

            <p className="mt-4 text-lg leading-8 text-slate-900">
              Choose ARB Bearings as your trusted Bearing Manufacturer in {city}
              , delivering precision-engineered, reliable, and high-performance
              bearing solutions.
            </p>
          </div>
            ...
            <div className="flex flex-col items-center justify-between gap-10 lg:flex-row">
              ...
              <div className="max-w-4xl">
                ...
                <p className="mt-3 text-lg leading-8 text-slate-200">
                  Get high-quality, precision-engineered bearings from ARB
                  Bearings. Whether you need standard bearings, specialized
                  solutions, or bulk requirements, our team is ready to help you
                  find the right bearing for your application.
                </p>
              </div>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-3 text-lg leading-8 text-slate-600">
                As a trusted Bearing Manufacturer in {city}, ARB Bearings
                follows a precision-focused manufacturing process to deliver
                reliable, durable, and high-performance bearing solutions. From
                premium raw materials to final inspection and packaging, every
                stage is carefully controlled to ensure consistent quality.
              </p>
          ...
          <div className="grid gap-16 lg:grid-cols-12">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-35 h-fit">
              ...
              <p className="mt-8 text-lg leading-8 text-slate-800">
                Find answers to the most commonly asked questions about ARB
                Bearings, our bearing solutions, manufacturing capabilities, and
                exports.
              </p>
